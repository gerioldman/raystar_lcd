/**
 * @file raystar_lcd_interface.h
 * @author gerioldman (k.gergo49@gmail.com)
 * @brief Defines interface for the driver to interact with hardware dependant calls
 */

#ifndef RAYSTAR_LCD_INTEFACE_H
#define RAYSTAR_LCD_INTEFACE_H
